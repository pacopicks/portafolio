...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Disponible para proyectos</span> <span className="text-primary/60">✦</span>
    <span>Retrato · Paisaje · Calle</span> <span className="text-secondary/60">✦</span>
    <span>Fotografía documental</span> <span className="text-primary/60">✦</span>
    <span>Trabajemos juntos</span> <span className="text-secondary/60">✦</span>
    <span>Luz natural</span> <span className="text-primary/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <MagneticButton
                  ...
                  className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group"
                >
                  <AtSign className="w-6 h-6 text-muted-foreground group-hover:text-foreground transition-colors" />
                  Ver Instagram
                </MagneticButton>
              </div>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Francisco. Todos los derechos reservados.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Francisco</span>
            </div>
